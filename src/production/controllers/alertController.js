...
const getAlerts = async (req, res) => {
  try {
    const storeId = req.query.factoryId || req.query.storeId || process.env.DEFAULT_STORE_ID || 'DS-Brooklyn-04';
    logger.info(`[Get Alerts] Request received - storeId/factoryId: ${storeId}, status: ${req.query.status || 'all'}`);
