...
function buildHeaderPathMap() {
  ...
  const entries = [
    ...
    { aliases: ['sku sub-classification', 'sku subclassification', 'sub classification', 'subclassification'], path: 'subClassification', kind: 'string' },
    ...
    { aliases: ['recv. validation code', 'recv validation code', 'receiving validation code', 'recv validation'], path: 'recvValidationCode', kind: 'string' },
