...
router.post('/zones/:id/request-riders', citywideController.requestZoneRiders);
...
router.post('/surge/actions', citywideController.executeSurgeAction);
...
router.post('/dispatch/manual-override', citywideController.manualOverrideDispatch);
router.get('/dispatch/logs', citywideController.getDispatchLogs);
