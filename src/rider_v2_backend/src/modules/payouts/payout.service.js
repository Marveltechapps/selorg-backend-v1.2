...
var _RiderShiftAssignment = require("../../../../rider/models/RiderShiftAssignment.js");
...
var getEarningsSummaryUncached = /*#__PURE__*/function () {
  var _refE = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _calleeE(riderId, period) {
    var now, periodStart, periodEnd, earnings, withdrawalsToday, assignments, onlineMinutes, activeIncentives, dayNames, dailyAgg;
    return _regenerator().w(function (_contextE) {
      while (1) switch (_contextE.n) {
        ...
        case 1:
          ...
          var orderCount = (earnings.orderIds || []).length;
          activeIncentives = [
            {
              id: '1',
              title: 'Daily Starter',
              subtitle: '5 orders',
              reward: '+₹50',
              completed: Math.min(orderCount, 5),
              target: 5,
              status: orderCount >= 5 ? 'unlocked' : 'active',
            },
            {
              id: '2',
              title: 'Order Pro',
              subtitle: '20 orders',
              reward: '+₹200',
              completed: Math.min(orderCount, 20),
              target: 20,
              status: orderCount >= 20 ? 'unlocked' : 'active',
            },
            {
              id: '3',
              ...
              subtitle: '50 orders',
              reward: '+₹500',
              completed: Math.min(orderCount, 50),
              target: 50,
              status: orderCount >= 50 ? 'unlocked' : 'active',
            }
          ];
